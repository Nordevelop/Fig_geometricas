...
public class Main {
	...
	public static void main(String[] args) {
		...
		float radio,altura,g,h,i,j;
		double lado7,radio1,k, u;
		ArrayList<Triangulo> Lista_Triangulo=new ArrayList<Triangulo>();
		...
		do
		{
		    ...
		    System.out.println("1-Triangulo. 2-Cuadrado. 3-Rectangulo.4-Circulo.5-Cilindro.6-Caja Rectangular.7-Cubo. 0-Para terminar");
		    op=entra.nextInt();
		    if (op ==1) {
	...
	while(!Pila_Triangulo.empty()) //REF Si la pila esta vacia
		
		{
		   ...
		   System.out.println("****************************************************************");
		   System.out.println("Ingreso " + Lista_Triangulo.size()+ " Triangulos");
